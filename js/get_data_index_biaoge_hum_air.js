...
window.setInterval(function(){$.ajax(getting_hum_air)},10000);
...
var option_index_hum_air = {
    title: {
                                ...
                                color: ["#9966ff", "#87cefa", "#da70d6", "#32cd32", "#6495ed", "#ff69b4", "#ba55d3", "#cd5c5c", "#ffa500", "#40e0d0", "#1e90ff", "#ff6347", "#7b68ee", "#00fa9a", "#ffd700", "#6699FF", "#ff6666", "#FFFFFF"],
                                tooltip: {
                                    trigger: "axis"
                                }
                            }
